...
####DISCLAIMER: You generally want to avoid "frameworks" when implementing CQRS or Event Sourcing but NEventLite will help get you on the rails. You can swap every aspect it of it if need be. Think of it as training wheels.
